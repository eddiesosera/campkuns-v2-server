...
const explorerController = require('../../../controllers/users/explorer.controller');

const router = express.Router();

router
    .route('/')
    .post(auth('manageExplorers'), validate(userValidation.createUser), explorerController.createExplorer)
    .get(auth('getExplorers'), validate(userValidation.getUsers), explorerController.getExplorers);
