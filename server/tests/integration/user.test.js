...
describe('User routes', () => {
  ...
  describe('GET /v2/users', () => {
    ...
    test('should return 401 if access token is missing', async () => {
      ...
      await request(app).get('/v2/users').send().expect(httpStatus.UNAUTHORIZED);
    });
  ...
  describe('GET /v2/users/:userId', () => {
    ...
    test('should return 401 error if access token is missing', async () => {
      ...
      await request(app).get(`/v2/users/${userOne._id}`).send().expect(httpStatus.UNAUTHORIZED);
    });
  ...
  describe('DELETE /v2/users/:userId', () => {
    ...
    test('should return 401 error if access token is missing', async () => {
      ...
      await request(app).delete(`/v2/users/${userOne._id}`).send().expect(httpStatus.UNAUTHORIZED);
    });
  ...
  describe('PATCH /v2/users/:userId', () => {
    ...
    test('should return 401 error if access token is missing', async () => {
      ...
      await request(app).patch(`/v2/users/${userOne._id}`).send(updateBody).expect(httpStatus.UNAUTHORIZED);
    });
